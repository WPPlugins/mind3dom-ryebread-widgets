		...
		<?php
			...
			foreach ($widgets as $w){
				...
				<div id="conf<?php echo $w->id; ?>" class="widget_conf" style="display:none;">
					...
					<table>
					<tr><td><?php _e("Order","RyeBread"); ?></td><td><input type="text" name="order" value="<?php echo $w->order; ?>" size="3"/></td></tr>
					<tr><td><?php _e("Skin","RyeBread"); ?></td><td><input type="text" name="skin" value="<?php echo $w->skin; ?>" size="30"/></td></tr>
					<tr><td><?php _e("Show on pages","RyeBread"); ?></td><td><textarea rows="4" cols="30" name="showon"><?php echo $w->showonpages; ?></textarea></td></tr>
					<tr><td><?php _e("Hide on pages","RyeBread"); ?></td><td><textarea rows="4" cols="30" name="hideon"><?php echo $w->hideonpages; ?></textarea></td></tr>
					</table>
					<div style="text-align:right;"><button id="save_<?php echo $w->id; ?>" onclick="javascript:this.disabled = true;jQuery(&quot;#confform<?php echo $w->id; ?>&quot;).submit();"><?php _e("Apply","RyeBread"); ?></button></div>
					</form>
				</div>
				</div>
				<?php
...
/*f (!function_exists('rb_call_ajax_handler')):
